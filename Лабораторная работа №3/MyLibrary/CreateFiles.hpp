...
public:
    ...
    void createMoney(char *moneyName) {
        fstream moneyBill;
        moneyBill.open(moneyName, ios::trunc | ios::in | ios::out | ios::binary);
        if(!moneyBill.is_open()) {
            cout << "Файл не открыт (bill)!" << endl;
            return;
        }
    ...
    void askManToPutMoney(char *moneyName) {
        int amountToPut, money;
        
        fstream moneyBill;
        moneyBill.open(moneyName, ios::in | ios::out | ios::binary);
        if(!moneyBill.is_open()) {
            cout << "Файл не открыт (bill)!" << endl;
            return;
        }
    ...
    void showAmountOfMoneyInVendingMachine(char *moneyName) {
        int amountToPut, money;
    ...
    void performOrder(char *moneyName) {
        fstream order;
    ...
    void showPurchases(char *moneyName) {
        fstream manBought;
